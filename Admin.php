...
<head>
  ...
  <title>Data Mahasiswa - Tables</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Database Mahasiswa</div>
          <div class="card-body">
            <div class="table-responsive">
            <a href="Input.php" class="btn btn-info btn-sm "aligen=right>Input Data</a><br><br>                 
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php  
                    while($user_data = mysqli_fetch_array($result)) {         
                        ...
                        echo "<td>" ;
                        echo "<a href='Edit.php?id=".$user_data['NIM']."'class='btn btn-warning btn-sm'>Update</a>"; 
                        echo "<a href='Delet.php?id=$user_data[NIM]' class='btn btn-danger btn-sm' >Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                        //echo "<a href='Update.php?id=".$isi['id']."'>Edit</a>  |";
                    } 
                    ?>
                </tbody>
              </table>
